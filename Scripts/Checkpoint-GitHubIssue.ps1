...
$msg="Installer lab build [$version]($installerBuildUri) includes commit {Commits} that relate to this task. Please test if it addresses the problem. If you use nuget add our [NugetServer]($nugetServerUri) as a nuget package source in VS.`r`n`r`n. Thanks a lot for your contribution."
$msg
