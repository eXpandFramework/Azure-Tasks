...
Install-Module XpandPosh -RequiredVersion 1.0.50 -Scope CurrentUser -Force -Repository PSGallery 
...
$msg
Checkpoint-GithubIssue -CommitIssues $commitIssues -Message $msg @cred -WhatIf