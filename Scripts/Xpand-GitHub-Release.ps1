...
iex "`$((New-Object System.Net.WebClient).DownloadString('http://install.expandframework.com'))"
Install-Xpand -Assets @('Assemblies','Nuget','VSIX','Source') $latest #-Version '$version'
``````
"@
if (!$notes){
